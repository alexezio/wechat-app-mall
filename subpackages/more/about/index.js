...
<p>开发者将在获取你的明示同意后，使用你的相册（仅写入）权限，用途是【商品评价展示】</p>

<p>开发者将在获取你的明示同意后，收集你的手机号，用途是【订单发货与登录使用】</p>

<p>开发者将在获取你的明示同意后，收集你的位置信息，用途是【订单发货】</p>

<p>开发者收集你选中的文件，用于商品评价展示。</p>

<p>开发者收集你选中的照片或视频信息，用于商品评价展示。</p>

<p>开发者收集你的地址，用于订单发货。</p>

<p>开发者读取你的剪切板，用于订单发货。</p>

<p>开发者获取你选择的位置信息，用于订单发货。</p>
